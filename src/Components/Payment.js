      ...
      <>
        {!success ? (
          ...
          <div className="h-full">
            <h2 className="text-whitesmoke text-xl text-center">
              You have now gained access to a new World.Keep Binging!!
            </h2>
            <Link to="/home">
              <button className="pay_button">explore the movie library</button>
            </Link>
          </div>
        )}
      </>
